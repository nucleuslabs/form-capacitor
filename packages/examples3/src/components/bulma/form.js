...
export function Radio({className,style,children,name,value,onChange}) {
    return <label className={cc([css.radio,className])}><input type="radio" name={name} value={value} onChange={onChange}/><span>{children}</span></label>;
}
